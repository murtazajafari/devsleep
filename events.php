                                        ...
                                        <div class="col-lg-6">
                                            <div class="card card-project">
                                                ...
                                                <div class="card-body">
                                                    <div class="dropdown card-options">
                                                        <button class="btn-options" type="button"
                                                            id="event-dropdown-button-3" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <i class="material-icons">more_vert</i>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <div class="card-title">
                                                        <a href="#">
                                                            <h5 data-filter-by="text">Eid ul Adha</h5>
                                                        </a>
                                                    </div>
                                                    <ul class="avatars">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card card-project">
                                                ...
                                                <div class="card-body">
                                                    <div class="dropdown card-options">
                                                        <button class="btn-options" type="button"
                                                            id="event-dropdown-button-4" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <i class="material-icons">more_vert</i>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <div class="card-title">
                                                        <a href="#">
                                                            <h5 data-filter-by="text">Eid ul Ghadir</h5>
                                                        </a>
                                                    </div>
                                                    <ul class="avatars">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card card-project">
                                                ...
                                                <div class="card-body">
                                                    <div class="dropdown card-options">
                                                        <button class="btn-options" type="button"
                                                            id="event-dropdown-button-5" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <i class="material-icons">more_vert</i>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <div class="card-title">
                                                        <a href="#">
                                                            <h5 data-filter-by="text">Ashura</h5>
                                                        </a>
                                                    </div>
                                                    <ul class="avatars">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card card-project">
                                                ...
                                                <div class="card-body">
                                                    <div class="dropdown card-options">
                                                        <button class="btn-options" type="button"
                                                            id="event-dropdown-button-6" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <i class="material-icons">more_vert</i>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <div class="card-title">
                                                        <a href="#">
                                                            <h5 data-filter-by="text">Arbaeen</h5>
                                                        </a>
                                                    </div>
                                                    <ul class="avatars">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card card-project">
                                                ...
                                                <div class="card-body">
                                                    <div class="dropdown card-options">
                                                        <button class="btn-options" type="button"
                                                            id="event-dropdown-button-7" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <i class="material-icons">more_vert</i>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <div class="card-title">
                                                        <a href="#">
                                                            <h5 data-filter-by="text">Milad un Nabi</h5>
                                                        </a>
                                                    </div>
                                                    <ul class="avatars">
                        ...
                        <form class="modal fade" id="event-add-modal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <ul class="nav nav-tabs nav-fill" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="event-add-details-tab" data-toggle="tab"
                                                href="#event-add-details" role="tab"
                                                aria-controls="event-add-details" aria-selected="true">Details</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="event-add-members-tab" data-toggle="tab"
                                                href="#event-add-members" role="tab"
                                                aria-controls="event-add-members" aria-selected="false">Members</a>
                                        </li>
                                    </ul>
                                    <div class="modal-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="event-add-members" role="tabpanel">
                                                <div class="users-manage" data-filter-list="form-group-users">
                                                    <div class="mb-3">
                                                        <ul class="avatars text-center">
                                                    ...
                                                    <div class="form-group-users">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-1" checked>
                                                            <label class="custom-control-label" for="event-user-1">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Claire Connors"
                                                                        src="assets/img/avatar-female-1.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-2" checked>
                                                            <label class="custom-control-label" for="event-user-2">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Marcus Simmons"
                                                                        src="assets/img/avatar-male-1.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-3" checked>
                                                            <label class="custom-control-label" for="event-user-3">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Peggy Brown"
                                                                        src="assets/img/avatar-female-2.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-4" checked>
                                                            <label class="custom-control-label" for="event-user-4">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Harry Xai"
                                                                        src="assets/img/avatar-male-2.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-5">
                                                            <label class="custom-control-label" for="event-user-5">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Sally Harper"
                                                                        src="assets/img/avatar-female-3.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-6">
                                                            <label class="custom-control-label" for="event-user-6">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Ravi Singh"
                                                                        src="assets/img/avatar-male-3.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-7">
                                                            <label class="custom-control-label" for="event-user-7">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Kristina Van Der Stroem"
                                                                        src="assets/img/avatar-female-4.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-8">
                                                            <label class="custom-control-label" for="event-user-8">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="David Whittaker"
                                                                        src="assets/img/avatar-male-4.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-9">
                                                            <label class="custom-control-label" for="event-user-9">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Kerri-Anne Banks"
                                                                        src="assets/img/avatar-female-5.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-10">
                                                            <label class="custom-control-label" for="event-user-10">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Masimba Sibanda"
                                                                        src="assets/img/avatar-male-5.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-11">
                                                            <label class="custom-control-label" for="event-user-11">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Krishna Bajaj"
                                                                        src="assets/img/avatar-female-6.jpg"
                                                                        class="avatar mr-2" />
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="event-user-12">
                                                            <label class="custom-control-label" for="event-user-12">
                                                                <span class="d-flex align-items-center">
                                                                    <img alt="Kenny Tran"
                                                                        src="assets/img/avatar-male-6.jpg"
                                                                        class="avatar mr-2" />
